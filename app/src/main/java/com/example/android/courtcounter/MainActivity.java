   ...
   * Stores values for global variables between different activities
    */
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putInt("scoreTeamFinn", scoreTeamFinn);
        outState.putInt("scoreTeamLotta", scoreTeamLotta);
    ...
    public void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        scoreTeamFinn = savedInstanceState.getInt("scoreTeamFinn");
        displayForTeamFinn(scoreTeamFinn);
        scoreTeamLotta = savedInstanceState.getInt("scoreTeamLotta");
